import {
  ...
  Tag, Home, Moon, Sun, LayoutDashboard, Target, Download, Gauge, Sparkles,
} from 'lucide-react'
...
export function IconSparkles({ size = 22 })    { return <Sparkles        size={size} strokeWidth={SW} aria-hidden="true" /> }
